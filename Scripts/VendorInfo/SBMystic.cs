    ...
    public class SBMystic : SBInfo
    {
        ...
        public class InternalBuyInfo : List<GenericBuyInfo>
        {
            public InternalBuyInfo()
            {
                ...
                Add(new GenericBuyInfo(typeof(Bloodmoss), 5, 20, 0xF7B, 0, true));
                ...
                Add(new GenericBuyInfo(typeof(Nightshade), 3, 20, 0xF88, 0, true));
                Add(new GenericBuyInfo(typeof(SulfurousAsh), 3, 20, 0xF8C, 0, true));
